...
CREATE INDEX IF EXISTS idx_table_info_ds ON adh_table_info(datasource_id);
CREATE INDEX IF EXISTS idx_table_info_active ON adh_table_info(is_active);
...
CREATE INDEX IF EXISTS idx_column_ds ON adh_column_metadata(datasource_id, table_name);
CREATE INDEX IF EXISTS idx_column_active ON adh_column_metadata(is_active);
...
CREATE INDEX IF EXISTS idx_template_active ON adh_sql_templates(is_active);
...
CREATE INDEX IF EXISTS idx_term_cn ON adh_business_terms(term_cn);
CREATE INDEX IF EXISTS idx_term_active ON adh_business_terms(is_active);
...
CREATE INDEX IF EXISTS idx_audit_user ON adh_query_audit(user_id);
CREATE INDEX IF EXISTS idx_audit_created ON adh_query_audit(created_at);
...
CREATE INDEX IF EXISTS idx_chart_dashboard ON adh_charts(dashboard_id);
...
CREATE INDEX IF EXISTS idx_snapshot_user ON adh_chart_snapshots(user_id);
...
CREATE INDEX IF EXISTS idx_conv_user ON adh_conversations(user_id);
...
CREATE INDEX IF EXISTS idx_relation_source ON adh_table_relations(source_table);
CREATE INDEX IF EXISTS idx_relation_target ON adh_table_relations(target_table);
CREATE INDEX IF EXISTS idx_relation_active ON adh_table_relations(is_active);
...
CREATE INDEX IF EXISTS idx_audit_log_user ON adh_audit_logs(user_id);
CREATE INDEX IF EXISTS idx_audit_log_created ON adh_audit_logs(created_at);
...
CREATE INDEX IF EXISTS idx_embed_app ON adh_embed_logs(app_id);
CREATE INDEX IF EXISTS idx_embed_created ON adh_embed_logs(created_at);
...
CREATE INDEX IF EXISTS idx_pv_key ON adh_prompt_versions(prompt_key);
CREATE INDEX IF EXISTS idx_pv_id ON adh_prompt_versions(prompt_id);
...
CREATE INDEX IF EXISTS idx_ws_workflow ON adh_workflow_steps(workflow_id);
...
CREATE INDEX IF EXISTS idx_wl_workflow ON adh_workflow_logs(workflow_id);
CREATE INDEX IF EXISTS idx_wl_session ON adh_workflow_logs(session_id);
CREATE INDEX IF EXISTS idx_wl_status ON adh_workflow_logs(status);
...
CREATE INDEX IF EXISTS idx_sc_status ON adh_sql_corrections(status);
...
CREATE INDEX IF EXISTS idx_pm_user ON adh_pipeline_metrics(user_id);
CREATE INDEX IF EXISTS idx_pm_created ON adh_pipeline_metrics(created_at);
