...
import {
  ...
  Clock, Bell, Star, Shield, Server, ClipboardList,
} from 'lucide-react';
...
const SYSTEM_MENU_ITEMS = [
  ...
  { key: '/system/relations', icon: Link, label: '数据建模' },
  ...
  { key: '/system/sandbox', icon: Server, label: '沙箱环境' },
  ...
  { section: '质量与安全' },
  { key: '/system/quality-review', icon: Star, label: '质量评审' },
  { section: '自动化' },
  ...
  { key: '/system/audit-logs', icon: ClipboardList, label: '审计日志' },
