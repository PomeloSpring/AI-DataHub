...
from backend.common.config import EMBEDDING_MODEL_PATH, EMBEDDING_MODEL_CACHE_DIR, EMBEDDING_DIM
...
def search_online_models(timeout: int = 15) -> list:
    ...
    if "HF_ENDPOINT" not in os.environ:
        from backend.common.config import EMBEDDING_HF_ENDPOINT
...
def set_active_model(model_path: str) -> dict:
    ...
    from backend.common.llm.embedding import reload_model
