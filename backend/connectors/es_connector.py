...
def es_mapping(index: str, datasource_id: int) -> dict:
    ...
    """
    from backend.nl2sql.sql.query_executor import _get_ds_conn_params, _build_es_client
...
def es_query(question: str, index_name: str, datasource_id: int) -> tuple[str, list[dict], str]:
    ...
    from backend.common.llm.llm_client import _get_model_config, _get_client_for_model
