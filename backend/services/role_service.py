...
class RoleService:
    ...
    def assign_user_role(self, user_id: int, role_id: int, workspace_id: int = 0) -> bool:
        ...
        try:
            with conn.cursor() as cur:
                cur.execute(
                    "INSERT OR IGNORE INTO adh_user_roles (id, user_id, role_id, workspace_id) VALUES (%s, %s, %s, %s)",
    ...
    def authorize_workspace_role(self, workspace_id: int, role_id: int) -> bool:
        ...
        try:
            with conn.cursor() as cur:
                cur.execute(
                    "INSERT OR IGNORE INTO adh_workspace_roles (id, workspace_id, role_id) VALUES (%s, %s, %s)",
