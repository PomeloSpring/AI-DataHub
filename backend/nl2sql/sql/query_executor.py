...
def execute_query(sql: str, datasource_id: int = None, query_type: str = "sql") -> tuple[pd.DataFrame, int, int]:
    """Execute a validated query against the specified datasource.

    For MySQL/Doris: executes SQL via pymysql.
    For Elasticsearch: routes to SQL, REST, or DSL based on query_type.
    ...
    # For Elasticsearch, route by query_type
