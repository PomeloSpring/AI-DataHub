...
from services.shared.common.config import EMBEDDING_MODEL_PATH, EMBEDDING_DIM, EMBEDDING_HF_ENDPOINT
...
def reload_model(model_path: str = None) -> dict:
    ...
    if model_path:
        ...
        import services.shared.common.config as cfg
...
def get_model_info() -> dict:
    ...
    from services.shared.common.config import EMBEDDING_MODEL_PATH as cfg_path, EMBEDDING_DIM as cfg_dim
