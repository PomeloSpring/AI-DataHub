...
class DAGExecutor:
    ...
    async def _execute_llm_analysis(self, node: DAGNode, input_data: Dict) -> Dict:
        ...
        from services.datamind.nl2sql.orchestrator.workflow.loop_engine import analyze_metadata_need
    ...
    async def _execute_result_analysis(self, node: DAGNode, input_data: Dict) -> Dict:
        ...
        from services.datamind.nl2sql.orchestrator.workflow.loop_engine import analyze_result
